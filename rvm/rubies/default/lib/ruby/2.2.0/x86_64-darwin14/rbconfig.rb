...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/haven/.rvm/rubies/ruby-2.2.3")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/haven/.rvm/rubies/ruby-2.2.3' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=dl/win32,fiddle/win32,tk/tkutil,tk,win32ole,-test-/win32/dln,-test-/win32/fd_setsize' '--sysconfdir=/etc' '--disable-install-doc' '--disable-shared' '--with-arch=x86_64' 'CC=gcc' 'CFLAGS=-O3 -I/Users/haven/.sm/pkg/active/include -fPIC -mmacosx-version-min=10.7' 'LDFLAGS=-L/Users/haven/.sm/pkg/active/lib -fPIC -Bstatic -lz'"
